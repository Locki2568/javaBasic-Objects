...
class ObjectTest {
    ...
    void should_choose_method_at_compile_time() {
        ...
        // <--start
        Object someOtherObject = "Obj";
        final String expected = fixture.methodWithOneParameter(someOtherObject);
        // --end-->
    ...
    void should_choose_the_most_specific_overload() {
        ...
        // TODO: please modify the following code to pass the test. You should write the result directly.
        // <--start
        final String expected = fixture.methodWithTwoParameters("Some string", 1);
        // --end-->
