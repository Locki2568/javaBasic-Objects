...
class InheritanceTest {
    ...
    void should_be_derived_from_object_class() {
        ...
        // <--start
        final Class<?> expectedSuperClass = Class.class.getSuperclass();
        // --end-->
    ...
    void should_call_super_class_methods() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String expectedName = instance.getClass().getSuperclass().getSimpleName() + "->DerivedFromBaseClassForOverridingCallingSuper";
        // --end-->
    ...
    void should_not_make_you_confused_2() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        final String expected = DerivedFromBaseClassWithName.class.getSuperclass().getSimpleName();
        // --end-->
